  ...
  <>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px', flex: 1, minHeight: 0 }}>
         <ServiceBox icon={<IconBolt />} title="Technical Support" desc="Identifying technical concerns and guiding customers through structured step-by-step solutions." />
         <ServiceBox icon={<IconBriefcase />} title="Issue Resolution" desc="Diagnosing and resolving software, account, and connectivity issues through deep analysis." />
         <ServiceBox icon={<IconLightbulb />} title="Escalation Management" desc="Handling complex cases and coordinating with internal teams to ensure timely resolution." />
         <ServiceBox icon={<IconHeart />} title="Customer Success" desc="Background in airline customer service and high-level interaction documentation." />
      </div>
    </div>
  </>
);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '16px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <a
          href="/resume.pdf"
          download="John_Frederick_Ocampo_CV.pdf"
...
const sendEmail = (e: React.FormEvent) => {
  ...
  // This console log will help you see if Vite is actually reading your .env
  console.log("Checking IDs:", { SERVICE_ID, TEMPLATE_ID, PUBLIC_KEY });

  // Use the Options Object format (this is the most reliable way)
